...
import org.glassfish.concurrent.ri.internal.ManagedScheduledThreadPoolExecutor;
...
public class ManagedScheduledExecutorServiceImpl extends AbstractManagedExecutorService 
    ...
    public ManagedScheduledExecutorServiceImpl(String name, 
        ...
        threadPoolExecutor = new /*Managed*/ManagedScheduledThreadPoolExecutor(corePoolSize, 
